...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/all_css/driver/Driverheader.css">
   ...
   <header class="header">
        ...
        <div class="nav-container">
            <nav class="nav-links">
                ...
                <a href="<%= request.getContextPath() %>/driver/driverDashboard.jsp" class="nav-item home-icon">
